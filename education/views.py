...
from .models import Quiz,Question,QuizResult,Answer,QuizResultDetail, QuizLimit
...
class QuizDetails(CreateAPIView):
    ...
    def get(self, request, id):
        ...
        if test:
            ...
            question = QuizLimit.objects.first()
            if question:
            ...
            if 'questions' in data:
                data['questions'] = data['questions'][:question_limit]
